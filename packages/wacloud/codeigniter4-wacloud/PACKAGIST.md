...
Panduan ini menjelaskan langkah-langkah untuk mempublikasikan package `wacloud/codeigniter4-wacloud` ke Packagist.
...
1. Buat repository baru di GitHub dengan nama `codeigniter4-wacloud`
2. Pastikan repository adalah **public** (Packagist hanya menerima package dari repository public)
3. Copy URL repository (contoh: `https://github.com/wacloud/codeigniter4-wacloud.git`)

### 2. Inisialisasi Git di Package

```bash
cd packages/wacloud/codeigniter4-wacloud
git init
git add .
git commit -m "Initial commit: WACloud CodeIgniter 4 Package v1.0.0"
```

### 3. Push ke GitHub

```bash
git remote add origin https://github.com/wacloud/codeigniter4-wacloud.git
git branch -M main
...
3. Masukkan URL repository GitHub: `https://github.com/wacloud/codeigniter4-wacloud`
...
2. Test install package sebelum publish:
   ```bash
   composer require wacloud/codeigniter4-wacloud:dev-main
   ```
